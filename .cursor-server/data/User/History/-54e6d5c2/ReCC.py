            ...
            if user_subscriptions:
                ...
                for i, subscription in enumerate(user_subscriptions, 1):
                    ...
                    if subscription.status == "active":
                        ...
                        message_text += f"❌ Подписка {subscription.status}\n"
                ...
                if active_subscription and config:
                    ...
                    if active_subscription.status == "active" and days_left <= 7:
                        extend_row = []
                    ...
                    if len(user_subscriptions) > 1:
                        ...
                        for sub in user_subscriptions:
                            if sub.status == "active":
                                manage_row.append(InlineKeyboardButton(text=f"🗑️ Удалить ключ #{user_subscriptions.index(sub)+1}", callback_data=f"delete_sub_{sub.id}"))
                        if manage_row:
